...
<body>
	...
	<div class="container center-box shadow-border">
        ...
        <form name="incommon" method='POST' action='admin_match_incommon.jsp' autocomplete="off" onsubmit="return validateForm()" >
	    ...
	    <c:forEach items="${categories.rows}" var="row" varStatus="rowCounter">
	        <tr><td>${row.id}</td><td><a href="admin_match_incommon.jsp?institution=${param.institution}&save=${row.name}">${row.name}</a></td><td>${row.country_name}</td></tr>
	    </c:forEach>
	    </table>
	</div>
